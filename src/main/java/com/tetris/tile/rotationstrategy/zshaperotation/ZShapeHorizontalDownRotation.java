 ...
 */
public class ZShapeHorizontalDownRotation extends RotationStrategy {
    @Override
    public boolean validate(Shape shape, RotationVariant rotationVariant) {
        return shape.equals(Shape.Z) && rotationVariant.equals(RotationVariant.HORIZONTALDOWN);
    }
    ...
    protected boolean isForthPositionAvailable(List<Field> fields) {
        ...
        return upperNeighbour.getNeighbour(Neighbour.LEFT) != null && !upperNeighbour.isNeighbourPlacedField(Neighbour.LEFT);
    }
