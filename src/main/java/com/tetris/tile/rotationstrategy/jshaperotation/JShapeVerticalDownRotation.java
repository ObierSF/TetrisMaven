 ...
 */
public class JShapeVerticalDownRotation extends RotationStrategy {
    @Override
    public boolean validate(Shape shape, RotationVariant rotationVariant) {
        return shape.equals(Shape.J) && rotationVariant.equals(RotationVariant.VERTICALDOWN);
    }
    ...
    protected boolean isForthPositionAvailable(List<Field> fields) {
        ...
        return upperNeighbour.getNeighbour(Neighbour.RIGHT) != null && !upperNeighbour.isNeighbourPlacedField(Neighbour.RIGHT);
    }
