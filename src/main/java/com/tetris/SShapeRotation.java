...
public enum SShapeRotation {
    ...
    HORIZONTALUP {
        ...
        private boolean isForthPositionAvailable(List<Field> fields) {
            return fields.get(1).getSurroundingFields().upper.getSurroundingFields().right != null
                    && !fields.get(2).getSurroundingFields().upper.getSurroundingFields().right.isPlacedField();
        }
    ...
    VERTICALUP {
        ...
        private boolean isForthPositionAvailable(List<Field> fields) {
            return fields.get(1).getSurroundingFields().right.getSurroundingFields().lower != null
                    && !fields.get(1).getSurroundingFields().right.getSurroundingFields().lower.isPlacedField();
        }
