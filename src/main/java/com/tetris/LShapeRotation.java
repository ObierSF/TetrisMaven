    ...
    HORIZONTALUP {
        ...
        private boolean isForthPositionAvailable(List<Field> fields) {
            return fields.get(1).getSurroundingFields().left.getSurroundingFields().upper != null
                    && !fields.get(2).getSurroundingFields().left.getSurroundingFields().upper.isPlacedField();
        }
    ...
    VERTICALUP {
        ...
        private boolean isForthPositionAvailable(List<Field> fields) {
            return fields.get(1).getSurroundingFields().lower.getSurroundingFields().right != null
                    && !fields.get(1).getSurroundingFields().lower.getSurroundingFields().right.isPlacedField();
        }
