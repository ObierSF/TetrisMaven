...
import com.tetris.Tile.RotationVariant.HorizontalDownRotationStrategy;
...
public class HorizontalDownRotationStrategyTest {
    ...
    public void shouldReturnProperRotationVariantIfTileWillBeHorizontalDownAfterRotatingLeft() throws Exception {
        ...
        //when
        if (strategyResponse = horizontalDownRotationStrategy.validate(verticalDownTile, "left")) {
            iShapeRotation = horizontalDownRotationStrategy.getIShapeRotation();
            //then
    ...
    public void shouldReturnProperRotationVariantIfTileWillBeHorizontalDownAfterRotatingRight() throws Exception {
        ...
        IShapeRotation iShapeRotation;
        //when
        if (strategyResponse = horizontalDownRotationStrategy.validate(verticalUpTile, "right")) {
            iShapeRotation = horizontalDownRotationStrategy.getIShapeRotation();
        //then
            assertEquals(IShapeRotation.HORIZONTALDOWN, iShapeRotation);
        }
    ...
    public void shouldReturnFalseForNotProperTile() throws Exception {
        ...
        boolean strategyResponse;
        //when
        strategyResponse = horizontalDownRotationStrategy.validate(verticalUpTile, "left");
        //then
